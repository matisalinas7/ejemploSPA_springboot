package com.ejemploSPA_auth0.demo.configuration.security;
...
public class SecurityConfiguration {
    ...
    @PostConstruct
    public void init() {
        System.out.println("CORS_ALLOWED_ORIGINS: " + corsAllowedOrigins);
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2ResourceServer(oauth02ResourceServer ->
                        oauth02ResourceServer
                                .jwt(jwt ->
                                        jwt
                                                .decoder(jwtDecoder())
    ...
    JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        converter.setAuthoritiesClaimName("https://api.ejemplo/roles");
